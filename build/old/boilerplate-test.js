...
window.onload = function() {
    ...
    <div id="postBackground"> 
          ...
          <div class=displaySignature> 
                        ...
                        <div id="postEmoticon">
                            <p class=${showEmoticon} style="color:${postAndArchive.post.emoticon};">${postAndArchive.post.emoticon}</p>
                        </div>
...
<div id="emoticonFeature">
  ...
  <div id="button-box">
    ...
    <div class="button flat" name="emoticon" value="(ಥ_ಥ)">
        <p id="emoticonText">(ಥ_ಥ)</p>
    </div>

    <div class="button flat" name="emoticon" value="(T⌓T)">
        <p id="emoticonText">(T⌓T)</p>
    </div>
